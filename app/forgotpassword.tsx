        ...
        <KeyboardAvoidingView style={tw`flex-1 px-4 mt-14`} enabled behavior={Platform.OS === 'ios' ? 'padding' : "height"}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={tw``}>
                    ...
                    <View style={tw`my-12`}>
                        <View style={tw`mb-4`}>
                            <Text style={tw`text-2xl mb-2 font-medium`}>Reset your password</Text>
                            <Text style={tw`text-base  text-slate-400`}>Enter your email assoicated with your account and we will send
                        ...
                        <Pressable style={tw`cursor-pointer mb-2 block w-full p-4 bg-violet-700 text-white rounded-lg hover:bg-black hover:text-white ${isLoading ? 'opacity-50' : ''}`}>
                            <Text style={tw`text-white text-center`}>Submit Email</Text>
                        </Pressable>
